...
system specified by Eqs.~\ref{eq:Karb2D_dc}-\ref{eq:Karb2D_J}.

The key to this is to ensure that the

This can be achieved by creating `ghost hexes' outside the boundary,
and fixing their values such that
$\nabla\vcdot\mathbf{J}_i(\mathbf{x}) = 0$.
